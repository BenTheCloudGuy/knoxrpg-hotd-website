---
title: "Godsteel Worldcarver (Longsword)"
category: Magic Item
rarity: Legendary
type: Weapon
requires_attunement: Yes
source: gsb2, pg. 92
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445172.png
---

# Godsteel Worldcarver (Longsword)

![Godsteel Worldcarver (Longsword)](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445172.png)

Weapon (longsword), legendary (requires attunement)
 
 
This hefty blade becomes miraculously nimble in hand, as if a portion of its weight were displaced elsewhere. You gain a +2 bonus to attack and damage rolls made with this magic weapon, which deals an extra 1d8 radiant damage to any target it hits.
...
The Griffon’s Saddlebag: Book Two, pg. 92
