---
title: "Failed Purity Spear"
category: Magic Item
rarity: Rare
type: Weapon
requires_attunement: Yes
source: gsb2, pg. 80
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445128.png
---

# Failed Purity Spear

![Failed Purity Spear](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445128.png)

Weapon (spear), rare (requires attunement)
 
 
The grayed unicorn horn that rests at the top of this sickly spear is fractured and slowly leaks a silver, corrupting fluid. A failed purity spear is the rare version of a purity spear (The Griffon's Saddlebag: Book One), a legendary weapon, that was made by a creature other than an elder fey. Its magic is a sad reminder that while unicorns are paragons of good, even their magic can become toxic when mistreated.
...
The Griffon’s Saddlebag: Book Two, pg. 80
