---
title: "Moonblade Longsword"
category: Magic Item
rarity: Legendary
type: Weapon
requires_attunement: Yes
source: dmg-2024, pg. 279
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9228854.png
---

# Moonblade Longsword

![Moonblade Longsword](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9228854.png)
...
61-75 
When you hit with an attack roll using the Moonblade, you deal an extra 1d6 Force damage. Each time the weapon gains this property after the first, the extra damage increases by 1d6, to a maximum of 3d6. Reroll if the Moonblade already deals an extra 3d6 Force damage on a hit. 
