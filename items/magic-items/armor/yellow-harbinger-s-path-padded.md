---
title: "Yellow Harbinger's Path (Padded)"
category: Magic Item
rarity: Very Rare
type: Armor
requires_attunement: Yes
source: gsb2, pg. 194
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445673.png
---

# Yellow Harbinger's Path (Padded)

![Yellow Harbinger's Path (Padded)](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445673.png)

Armor (padded), very rare (requires attunement by a a creature with a Dexterity score of 17 or higher)
