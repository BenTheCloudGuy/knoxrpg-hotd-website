---
title: "Yellow Harbinger's Path (Leather)"
category: Magic Item
rarity: Very Rare
type: Armor
requires_attunement: Yes
source: gsb2, pg. 194
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445672.png
---

# Yellow Harbinger's Path (Leather)

![Yellow Harbinger's Path (Leather)](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445672.png)

Armor (leather), very rare (requires attunement by a a creature with a Dexterity score of 17 or higher)
