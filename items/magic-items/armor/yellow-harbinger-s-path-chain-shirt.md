---
title: "Yellow Harbinger's Path (Chain Shirt)"
category: Magic Item
rarity: Very Rare
type: Armor
requires_attunement: Yes
source: gsb2, pg. 194
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445669.png
---

# Yellow Harbinger's Path (Chain Shirt)

![Yellow Harbinger's Path (Chain Shirt)](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445669.png)

Armor (chain shirt), very rare (requires attunement by a a creature with a Dexterity score of 17 or higher)
