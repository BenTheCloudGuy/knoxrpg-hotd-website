---
title: "Yellow Harbinger's Path (Breastplate)"
category: Magic Item
rarity: Very Rare
type: Armor
requires_attunement: Yes
source: gsb2, pg. 194
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445668.png
---

# Yellow Harbinger's Path (Breastplate)

![Yellow Harbinger's Path (Breastplate)](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445668.png)

Armor (breastplate), very rare (requires attunement by a a creature with a Dexterity score of 17 or higher)
