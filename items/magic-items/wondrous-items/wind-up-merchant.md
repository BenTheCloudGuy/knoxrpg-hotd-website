---
title: "Wind-Up Merchant"
category: Magic Item
rarity: Rare
type: WondrousItem
requires_attunement: No
source: gsb2, pg. 191
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445648.png
---

# Wind-Up Merchant

![Wind-Up Merchant](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445648.png)
...
3 
spell scroll, 1st level: comprehend languages (25%), detect magic (25%), feather fall (25%), or identify (25%) 
25gp 
...
The toy remains animated for 5 minutes or until each item has been purchased from the list. When the toy stops animating, any deposited coins that weren’t spent on the listed items clatter to the ground below it, converting them into smaller denominations as needed, and the parchment turns to dust and is destroyed. An item purchased from the wind-up merchant disappears after 24 hours, or early if you attempt to sell or trade it to another creature.

The Griffon’s Saddlebag: Book Two, pg. 191
