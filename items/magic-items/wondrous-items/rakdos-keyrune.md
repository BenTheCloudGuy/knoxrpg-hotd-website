...
source: ggtr
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/313820.png
---

# Rakdos Keyrune

![Rakdos Keyrune](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/313820.png)

Wondrous Item, uncommon (requires attunement by a member of the relevant guild)
 
 
Rakdos Keyrune (Uncommon). This dark granite keyrune is marbled with scarlet veins and carved with the leering visage of a mischievous demon. When activated, it transforms into a cackler for up to 1 hour.
