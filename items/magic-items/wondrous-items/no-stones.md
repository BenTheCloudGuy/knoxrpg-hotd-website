...
source: gsb2, pg. 130
image: https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445336.png
---

# No-Stones

![No-Stones](https://cloudgeekcusgaming01.blob.core.windows.net/images/magic-items/9445336.png)
...
The geode remains fixed in place until you speak its command word again using a bonus action, its surface moves, or it’s forced to hold more than 100 pounds. A creature can use an action to make a DC 15 Strength check, moving the geode and causing the map to vanish. Once a half has been used in this way, that half can’t be used again until the next dawn.

The Griffon’s Saddlebag: Book Two, pg. 130
