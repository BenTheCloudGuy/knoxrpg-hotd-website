...
const NAV_ITEMS = [
  ...
  },
  {
    label: "\u2699 DM Command Center", adminOnly: true, dropdown: [
      ...
      { header: "DDB Authoring" },
      { label: "Magic Item", href: "/dm-admin#hb-magic-item" },
      { label: "Feat", href: "/dm-admin#hb-feat" },
      { label: "Spell", href: "/dm-admin#hb-spell" },
      { label: "Monster", href: "/dm-admin#hb-monster" },
      { label: "Species", href: "/dm-admin#hb-species" },
      { label: "Sub-Class", href: "/dm-admin#hb-subclass" },
      { label: "Background", href: "/dm-admin#hb-background" },
      { header: "Config" },
